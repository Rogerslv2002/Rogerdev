...
export default function Contatos(){
    return(
        <section id="Contato" className=" w-full px-20 py-10 md:px-5 ">
            <h2 className=" text-center text-white my-5 text-5xl font-semibold 2xl:text-7xl"> Contatos</h2>
            <p className=" text-center text-white text-xl mb-10 font-medium 2xl:text-3xl">Entre em contato comigo!</p>
            ...
            < Card LINK={()=>Links("https://www.instagram.com/roger.sl.dev/")} Icon={<AiOutlineInstagram/>} Titulo={"Instagram"} Texto={'Roger.sl.dev'}/>
